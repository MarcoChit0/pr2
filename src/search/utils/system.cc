...
const char *get_exit_code_message_reentrant(ExitCode exitcode) {
    ...
    case ExitCode::STRONG_CYCLIC:
        return "Strong cyclic solution found.";
    case ExitCode::STRONG:
        return "Strong acyclic solution found.";
    case ExitCode::NOT_STRONG_CYCLIC:
        return "No strong (a)cyclic solution found.";
    default:
        return nullptr;
    }
}
